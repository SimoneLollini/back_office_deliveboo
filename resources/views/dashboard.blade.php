...
@section('content')
@if ($user_restaurant)
<div class="shadow-sm mx-0 py-3 ">

    <h1 class="text_dark_red text-center py-2 fw-bold ps-3">Pannello di amministrazione<img class="dashboard_icon ms-3"
            src="{{ asset('/img/dashboard_icon.png') }}" alt=""></h1>
</div>

<div class="container align-items-center card shadow p-5 rounded-4 border-0 mt-4">
